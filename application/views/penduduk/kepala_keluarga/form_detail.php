<?php $this->load->view('penduduk/header'); ?>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <tr>
                <th>Aksi</th>
                <td>
                <a href="" class="btn btn-warning" data-toggle="modal" data-target="#editKK<?= $token ?>"><i class="fa fa-edit"></i>
                </td>
            </tr>
        </table>
        </div>
...
<div class="modal fade" id="uploadKK<?= $token ?>" tabindex="-1" role="dialog"
        aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header bg-purple">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body table-responsive">
                    ...
                    <p style="color: red;">Yang bertanda * wajib diisi</p>
                        <form action="<?= base_url('penduduk/anggota/add') ?>" method="post" enctype="multipart/form-data">
                            <tr>
                                <th>No KK *</th>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td><input type="text" name="ayah" class="form-control" placeholder="Nama ayah"></td>
                            </tr>
                            <tr>
                                <th>Nama ibu</th>
                            </tr>
                            <tr>
                                <td><input type="text" name="ibu" class="form-control" placeholder="Nama ibu"></td>
                            </tr>
                        </table>
                            <a href="" class="btn btn-default" data-dismiss="modal">Kembali</a> &nbsp; &nbsp;
                            <input type="submit" name="kirim" value="Simpan" class="btn btn-success">
...
<div class="modal fade" id="editAnggotaKK<?= $kk['id_anggota'] ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body table-responsive">
                    <table class="table table-bordered table-striped">
                        <form action="<?= base_url('penduduk/anggota/edit/'.$kk['id_anggota']) ?>" method="post" enctype="multipart/form-data">
                            <tr>
