...
<table class="table table-reposive">
    <form id="edit_map" method="post">
        ...
        <tr>
            <td></td>
            <th>
                <a href="<?= base_url('admin/kepala_keluarga/detail/'.$id_kk) ?>" class="btn btn-warning">Batal</a>
...
$(document).on('submit', '#edit_map', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('admin/kepala_keluarga/api_edit_maps/') ?>" + form_data.get('id_kk'),
            dataType: "json",
            data: form_data,
            processData: false,
            contentType: false,
            ...
            success: function(data) {
                ...
                swal({
                    ...
                    location.href = "<?= site_url('admin/kepala_keluarga/detail/') ?>" + form_data.get('id_kk');
                });
            },
            error: function(data) {
                swal({
