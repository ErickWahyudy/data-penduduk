                ...
                <div class="modal-body table-responsive">
                    <table class="table table-bordered table-striped">
                        <form action="<?= base_url('ketua_rt/kepala_keluarga/add') ?>" method="post"
                            ...
                            <tr>
                                <td><input type="number" name="nik_ktp" class="form-control" required placeholder="NIK" pattern="[0-9]+"></td>
                            </tr>
                            <tr>
                                <th>Nama</th>
                            </tr>
                            <tr>
                                <td><input type="text" name="nama_kk" class="form-control" required placeholder="Nama Lengkap" pattern="[A-Za-z ]+"></td>
                            </tr>
                            <tr>
                                <th>Tanggal Lahir</th>
                            </tr>
