            ...
            <div class="modal-content">
                ...
                <div class="modal-body table-responsive">
                    <table class="table table-bordered table-striped">
                        ...
                        <form action="<?= base_url('ketua_rt/data_lain/add') ?>" method="post"
    ...
    <div class="modal fade" id="edit<?= $data_lain['id_data_lain'] ?>" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body table-responsive">
                    <table class="table table-bordered table-striped">
                        <form action="<?= base_url('ketua_rt/data_lain/edit/'.$data_lain['id_data_lain']) ?>" method="post"
                            enctype="multipart/form-data">
                            <tr>
                                <th>Nama *</th>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    ...
                                    &nbsp;&nbsp;
                                    <a href="<?= base_url('ketua_rt/data_lain/hapus/'.$data_lain['id_data_lain']) ?>"
