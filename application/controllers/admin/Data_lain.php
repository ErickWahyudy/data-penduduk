...
class Data_lain extends CI_controller
{
  ...
  {
    $kode_tahun = date('Y');
    $view = array('judul'   =>'Data Lainnya',
              'data'        =>$this->m_data_lain->view(),
            );
     $this->load->view('admin/data_lain/form',$view);
  }
   ...
   public function add($value='') {    
    if (isset($_POST['kirim'])) {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            redirect(base_url('admin/data_lain'));
        }
      else
 ...
 if (isset($_POST['kirim'])) {     
  ...
  if($cek){
   ...
   echo "QUERY SQL ERROR";
      	...
      	$this->load->view('admin/data_lain/form',$x);
      }
    }
